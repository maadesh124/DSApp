...
import 'package:fp4/CustomWidgets/Overviews.dart' as DS;
import 'package:fp4/CustomWidgets/PageWidgets.dart';
import 'package:fp4/Learner/OverViews.dart';
...
class SchoolTabs extends StatefulWidget {
  ...
  SchoolTabs({super.key,required this.drivingSchool});
...
Widget getOverView({required dynamic model,required String type,})
{
  switch (type) {
    ...
    case Model.SERVICE:
      return DS.ServiceOverview(service: model!,);
    case Model.INSTRUCTOR:
